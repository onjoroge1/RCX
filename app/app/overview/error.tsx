      ...
      <Card className="mx-auto mt-10 max-w-lg p-6">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <h1 className="text-base font-semibold text-foreground">Dashboard metrics could not be loaded</h1>
            <p className="mt-1 text-sm text-muted-foreground">
              This affects reporting only — your journeys are still running and customer messaging is
              unaffected.
            </p>
            {error.digest && (
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Button size="sm" variant="outline" asChild>
                <a href="/app/conversations">Go to conversations</a>
              </Button>
            </div>
          </div>
        </div>
